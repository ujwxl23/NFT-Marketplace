...
contract NFTMarketplace is Ownable, ERC721URIStorage, ERC721Enumerable {
    ...
    function setRoyaltiesReceiver(
        ...
        require(newRoyaltiesReceiver != royaltyReciever); // dev: Same address
        royaltyReciever = newRoyaltiesReceiver;
    }
    ...
    function royaltyInfo(
        ...
        return (royaltyReciever, _royalties);
    }
